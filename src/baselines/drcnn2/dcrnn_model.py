...
from baselines.drcnn2.dcrnn_cell import DCGRUCell
import random
from baselines.drcnn2.base_model import BaseModel
...
class DCRNNModel(BaseModel):
    ...
    def forward(self, source, target, teacher_forcing_ratio=0):
        ...
        outputs = self.decoder(decoder_input, context, teacher_forcing_ratio=teacher_forcing_ratio)
