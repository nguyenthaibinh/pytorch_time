...
def get_model(args, adj_matrix):
    ...
    #                  in_dim=2, horizon=12, residual_channels=32, dilation_channels=32, skip_channels=256,
    #                  end_channels=512, kernel_size=2, blocks=4, layers=2
    model = GWNETMAT(in_dim=args.in_dim, horizon=args.horizon, num_nodes=args.num_nodes, device=args.device,
                     ...
                     blocks=args.blocks, layers=args.block_layers, dropout=args.dropout)
