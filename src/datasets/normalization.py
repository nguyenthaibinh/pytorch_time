...
class MinMax01Scaler:
    ...
    def scaler_info(self):
        print(f"MinMax01Scaler::min/max: {self.min:.4f}/{self.max:.4f}")
...
class MinMax11Scaler:
    ...
    def scaler_info(self):
        print(f"MinMax11Scaler::min/max: {self.min:.4f}/{self.max:.4f}")
...
class ColumnMinMaxScaler():
    ...
    def scaler_info(self):
        print(f"ColumnMinMaxScaler::min/min_max: {self.min:.4f}/{self.min_max:.4f}")
